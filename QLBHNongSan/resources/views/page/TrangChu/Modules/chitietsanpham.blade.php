       ...
       <div class="row">
         ...
         <div class="aa-product-details-content">
           ...
           <div class="col-md-5 col-sm-5 col-xs-12">
             ...
             <a href="{!! asset('resources/upload/sanpham/'.$sanpham->anh) !!}" class="MagicZoom" id="jeans" data-options="selectorTrigger: hover; transitionEffect: false;">
             <img src="{!! asset('resources/upload/sanpham/'.$sanpham->anh) !!}" style="width: 250px; height: 300px;"></a> 
